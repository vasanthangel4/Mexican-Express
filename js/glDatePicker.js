	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var dowNames = options.dowNames || [ 'Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado' ];
					...
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							if(!isSelectable ||
								...
								cellClass = ([ 'Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado' ])[cellDateVal.day];
